...
namespace Microsoft.ReverseProxy.ServiceFabric
{
    ...
    /// </summary>
    public static class LabelsBinder
    {
        /// <summary>
        ...
        public static T Get<T>(IConfiguration configuration, Action<BinderOptions> configureOptions)
        {
            ...
            var result = Get(configuration, typeof(T), configureOptions);
            if (result == null)
            {
                return default(T);
            }
        ...
        /// <param name="configureOptions">Configures the binder options.</param>
        /// <returns>The new instance if successful, null otherwise.</returns>
        public static object Get(IConfiguration configuration, Type type, Action<BinderOptions> configureOptions)
        {
            if (configuration == null)
            {
                throw new ArgumentNullException(nameof(configuration));
